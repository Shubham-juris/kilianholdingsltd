...
const AboutSection = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-flow-col grid-rows-2 gap-[5rem] justify-evenly  p-12">
        <div className="text-center  w-[33rem]">
          <img className="w-[100%] h-[10rem]   mx-auto" src={img} alt="img" />
          <h1 className="text-xl text-gray-100 font-bold mt-4">Our Team</h1>
          <p className="text-gray-100 mt-2 text-xs p-6">
