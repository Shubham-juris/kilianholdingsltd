...
const AboutSection = () => {
  return (
    <Box sx={{
      ...
      <div className="flex justify-around items-center space-x-10 px-10">
        <div className="w-[45%] text-center">
          <img className="w-[80%] mx-auto" src={img} alt="img" />
          <h1 className="text-xl text-gray-100 font-bold mt-4">Our Team</h1>
          <p className="text-gray-100 mt-2">
            At Kilian Holdings, our team is comprised of highly skilled and dedicated paralegals who are committed to
            providing exceptional service to our clients. With a diverse range of expertise and backgrounds in the legal
            field, our team is equipped to handle various documentation needs with precision and professionalism.
          </p>
        </div>

        <div className="w-[45%] flex justify-center">
          <img className="w-[80%] mx-auto" src={img} alt="img" />
          <h1 className="text-xl text-gray-100 font-bold mt-4">Personalized attention </h1>
          <p className="text-gray-100 mt-2">Since every legal case is different, we at Kilian Holdings take the time to hear your worries, comprehend your objectives, and create a customized plan of action that will help you get the greatest result possible. Throughout the whole process, from the first consultation to the case's settlement, you can rely on us to provide documentation support.
          </p>
        </div>
      </div>
